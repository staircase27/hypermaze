...
const pair<KeyMap::Action,const wchar_t*> KeyMap::actionNames[A_COUNT-1]={
      ...
      pair<KeyMap::Action,const wchar_t*>(KeyMap::A_SLIDE_END_IN,L"Extend End of Selection Outwards"),
      pair<KeyMap::Action,const wchar_t*>(KeyMap::A_SLIDE_END_OUT,L"Shrink End of Selection Inwards"),
