...
const pair<KeyMap::Action,wchar_t*> KeyMap::actionNames[A_COUNT-1]={
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_GENERATE,L"A_GENERATE"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_LOAD,L"A_LOAD"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SAVE,L"A_SAVE"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_CONF,L"A_CONF"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_MOVE_UP,L"A_MOVE_UP"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_MOVE_DOWN,L"A_MOVE_DOWN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_MOVE_LEFT,L"A_MOVE_LEFT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_MOVE_RIGHT,L"A_MOVE_RIGHT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_MOVE_FORWARD,L"A_MOVE_FORWARD"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_MOVE_BACK,L"A_MOVE_BACK"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLIDE_START_OUT,L"A_SLIDE_START_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLIDE_START_IN,L"A_SLIDE_START_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLIDE_END_IN,L"A_SLIDE_END_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLIDE_END_OUT,L"A_SLIDE_END_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_UP_IN,L"A_SLICE_UP_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_UP_OUT,L"A_SLICE_UP_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_DOWN_IN,L"A_SLICE_DOWN_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_DOWN_OUT,L"A_SLICE_DOWN_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_LEFT_IN,L"A_SLICE_LEFT_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_LEFT_OUT,L"A_SLICE_LEFT_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_RIGHT_IN,L"A_SLICE_RIGHT_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_RIGHT_OUT,L"A_SLICE_RIGHT_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_FORWARD_IN,L"A_SLICE_FORWARD_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_FORWARD_OUT,L"A_SLICE_FORWARD_OUT"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_BACK_IN,L"A_SLICE_BACK_IN"),
      pair<KeyMap::Action,wchar_t*>(KeyMap::A_SLICE_BACK_OUT,L"A_SLICE_BACK_OUT")};
